...
def predict_crop(N, P, K, temperature, humidity, pH, rainfall):  # Create a numpy array with the input values
...
if pred == 1:
    ...
    print("Black gram is the best crop to be cultivated right there")
elif pred == 17:
    print("Mung-bean is the best crop to be cultivated right there")
elif pred == 18:
    print("Moth beans is the best crop to be cultivated right there")
elif pred == 19:
    print("Pigeon-peas is the best crop to be cultivated right there")
elif pred == 20:
    print("Kidney-beans is the best crop to be cultivated right there")
elif pred == 21:
